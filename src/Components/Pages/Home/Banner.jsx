      ...
      <div className="hero-content text-center">
        <div className="max-w-md text-left">
          ...
          <div className="flex gap-4 ">
            <button className="btn btn-primary btn-lg rounded-full bg-[#f7881f] border-none text-white shadow-xl hover:text-[#f7881f] hover:bg-white ">
              Order Now
              <AiOutlineRightCircle className="text-5xl" />
            </button>
            <button className="btn btn-primary btn-lg rounded-full bg-white text-[#361e31] shadow-xl border-none hover:text-white hover:bg-[#361e31]">
              Contact
              <AiOutlineRightCircle className="text-5xl" />
            </button>
          </div>
